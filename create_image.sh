# Commit a new image with modification

docker commit -m "nmap installed" -a "Deepak" 9332f dpak120/my_centos:latest
docker images
docker container run -it dpak120/my_centos


# Tagging same images
docker image tag nginx dpkt120/my_centos:latest

docker image tag dpkt120/my_centos:latest dpkt120/my_centos:1.0
